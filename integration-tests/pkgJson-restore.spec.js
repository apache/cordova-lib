    ...
    */
    it('Test#000 : tests that the spec (~,^) is added and updated as expected in config.xml', function(done) {
        ...
        emptyPlatformList().then(function() {
            ...
            return cordova.platform('add', androidPlatform, {'save':true , 'fetch':true});
        }).then(function() {
    ...
    */
    it('Test#017 : test to make sure that platform url is added and restored properly', function(done) {
        ...
        emptyPlatformList().then(function() {
            ...
            return cordova.platform('add', 'https://github.com/apache/cordova-browser', {'save':true, 'fetch':true});
        }).then(function() {
    ...
    */
    it('Test#018 : test to make sure that plugin url is added and restored properly', function(done) {
        ...
        emptyPlatformList().then(function() {
            ...
            return cordova.plugin('add', ['https://github.com/apache/cordova-plugin-splashscreen'], {'save':true, 'fetch':true});
        }).then(function() {
            ...
            return cordova.plugin('rm', 'cordova-plugin-splashscreen', {'fetch':true});
        }).then(function() {
