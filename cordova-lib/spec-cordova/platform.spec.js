...
describe('add function', function () {
    ...
    it('throws if target platform is incompatible with current os/platform', function (done) {
        ...
        platform.add(hooksRunnerMock, projectRoot, targets, opts).fail(function (error) {
            expect(error.message).toBe("Applications for platform ios can not be built on this OS - " + currentPlatform + ".");
            done();
        });
    });
