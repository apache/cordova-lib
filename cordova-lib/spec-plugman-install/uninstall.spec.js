/**
    ...
    under the License.
*/
var uninstall = require('../src/plugman/install/uninstall'),
    ...
    srcProject = path.join(spec, '..', 'fixtures-plugman', 'projects', 'android_uninstall'),
    project = path.join(spec, '..', 'fixtures-plugman', 'projects', 'android_uninstall.test'),
    project2 = path.join(spec, '..', 'fixtures-plugman', 'projects', 'android_uninstall.test2'),
