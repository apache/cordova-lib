...
var ios = require('../../src/plugman/platforms/ios'),
    ...
    ios_config_xml_project = path.join(__dirname, '..', '..', 'fixtures-plugman', 'projects', 'ios-config-xml', '*'),
    ...
    weblessplugin = path.join(__dirname, '..', '..', 'fixtures-plugman', 'plugins', 'WeblessPlugin'),
    done = false;
