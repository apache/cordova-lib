    ...
    describe(platform + ' project handler', function () {
        ...
        describe('installation', function () {
            ...
            describe('of <framework> elements of type \'projectReference\'', function () {
                ...
                it('should write to correct project files when conditions are specified', function () {
                    var xpath = 'ProjectReference[@Include="' + windowsJoin(dummyplugin, 'src', 'windows8', 'dummy1.vcxproj') + '"][@Condition="\'$(Platform)\'==\'x64\'"]';
                    validateInstalledProjects('framework', frameworks[4], xpath, ['all']);

                    xpath = 'ProjectReference[@Include="' + windowsJoin(dummyplugin, 'src', 'windows8', 'dummy2.vcxproj') + '"]';
                    validateInstalledProjects('framework', frameworks[5], xpath, ['windows8']);

                    xpath = 'ProjectReference[@Include="' + windowsJoin(dummyplugin, 'src', 'windows8', 'dummy3.vcxproj') + '"]';
                    validateInstalledProjects('framework', frameworks[6], xpath, ['windows', 'windows8']);

                    xpath = 'ProjectReference[@Include="' + windowsJoin(dummyplugin, 'src', 'windows8', 'dummy4.vcxproj') + '"][@Condition="\'$(Platform)\'==\'x86\'"]';
        ...
        describe('uninstallation', function () {
            ...
            describe('of <lib-file> elements', function () {
                ...
                it('should remove from correct project files when conditions specified', function (done) {
                    ...
                    install('windows', cordovaProjectWindowsPlatformDir, dummyplugin, cordovaProjectPluginsDir, {})
                        .then(function () {
                            var xmlPath = 'ItemGroup/SDKReference';
                            var incText = 'TestSDK1, Version=1.0';
                            var targetConditions = {versions: undefined, target: undefined, arch: 'x86'};
                            validateUninstalledProjects('lib-file', libfiles[0], xmlPath, incText, targetConditions, ['all']);

                            incText = 'TestSDK2, Version=1.0';
                            targetConditions = {versions: '>=8.1', target: undefined, arch: undefined};
                            validateUninstalledProjects('lib-file', libfiles[1], xmlPath, incText, targetConditions, ['windows', 'phone']);

                            incText = 'TestSDK3, Version=1.0';
                            targetConditions = {versions: undefined, target: 'phone', arch: undefined};
                            validateUninstalledProjects('lib-file', libfiles[2], xmlPath, incText, targetConditions, ['phone']);

                            incText = 'TestSDK4, Version=1.0';
                            targetConditions = {versions: '8.0', target: 'windows', arch: 'x86'};
                            validateUninstalledProjects('lib-file', libfiles[3], xmlPath, incText, targetConditions, ['windows8']);
            ...
            describe('of <framework> elements', function () {
                ...
                it('should remove from correct project files when conditions specified', function (done) {
                    ...
                    install('windows', cordovaProjectWindowsPlatformDir, dummyplugin, cordovaProjectPluginsDir, {})
                        .then(function () {
                            var xmlPath = 'ItemGroup/Reference';
                            var incText = 'dummy1';
                            var targetConditions = {versions: undefined, target: undefined, arch: 'x64'};
                            validateUninstalledProjects('framework', frameworks[0], xmlPath, incText, targetConditions, ['all']);

                            incText = 'dummy2';
                            targetConditions = {versions: '>=8.0', target: undefined, arch: undefined};
                            validateUninstalledProjects('framework', frameworks[1], xmlPath, incText, targetConditions, ['all']);

                            incText = 'dummy3';
                            targetConditions = {versions: undefined, target: 'windows', arch: undefined};
                            validateUninstalledProjects('framework', frameworks[2], xmlPath, incText, targetConditions, ['windows', 'windows8']);

                            incText = 'dummy4';
                            targetConditions = {versions: '8.1', target: 'phone', arch: 'ARM'};
                            validateUninstalledProjects('framework', frameworks[3], xmlPath, incText, targetConditions, ['phone']);
                ...
                it('should remove from correct project files when conditions specified', function (done) {
                    ...
                    install('windows', cordovaProjectWindowsPlatformDir, dummyplugin, cordovaProjectPluginsDir, {})
                        .then(function () {
                            ...
                            var incText = windowsJoin(cordovaProjectPluginsDir, dummy_id, 'src', 'windows8', 'dummy1.vcxproj');
                            var targetConditions = {versions: undefined, target: undefined, arch: 'x64'};
                            validateUninstalledProjects('framework', frameworks[4], xmlPath, incText, targetConditions, ['all']);

                            incText = windowsJoin(cordovaProjectPluginsDir, dummy_id, 'src', 'windows8', 'dummy2.vcxproj');
                            targetConditions = {versions: '<8.1', target: undefined, arch: undefined};
                            validateUninstalledProjects('framework', frameworks[5], xmlPath, incText, targetConditions, ['windows8']);

                            incText = windowsJoin(cordovaProjectPluginsDir, dummy_id, 'src', 'windows8', 'dummy3.vcxproj');
                            ...
                            incText = windowsJoin(cordovaProjectPluginsDir, dummy_id, 'src', 'windows8', 'dummy4.vcxproj');
