...
var configChanges = require('../../src/plugman/util/config-changes'),
    ...
    cbplugin = path.join(__dirname, '..', '..', 'fixtures-plugman', 'plugins', 'ChildBrowser'),
    childrenplugin = path.join(__dirname, '..', '..', 'fixtures-plugman', 'plugins', 'multiple-children'),
    shareddepsplugin = path.join(__dirname, '..', '..', 'fixtures-plugman', 'plugins', 'shared-deps-multi-child'),
    configplugin = path.join(__dirname, '..', '..', 'fixtures-plugman', 'plugins', 'ConfigTestPlugin'),
    varplugin = path.join(__dirname, '..', '..', 'fixtures-plugman', 'plugins', 'VariablePlugin'),
    android_two_project = path.join(__dirname, '..', '..', 'fixtures-plugman', 'projects', 'android_two', '*'),
    android_two_no_perms_project = path.join(__dirname, '..', '..', 'fixtures-plugman', 'projects', 'android_two_no_perms', '*'),
    ios_plist_project = path.join(__dirname, '..', '..', 'fixtures-plugman', 'projects', 'ios-plist', '*'),
    ios_config_xml = path.join(__dirname, '..', '..', 'fixtures-plugman', 'projects', 'ios-config-xml', '*'),
